...
ASSET_QUERY = os.environ.get("ASSET_QUERY", "21")
...
def preface() -> str:
  ...
  <p class="callout__lede">
    Use the <strong>prompt builder</strong> below to generate a starter message (click choices; type only your path), then paste the
    ...
    as the next user message if your client did not already load it. The rubric tells the agent how to plan, scan, and report A–K.
  </p>
